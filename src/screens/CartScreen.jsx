    ...
    <View style={styles.card}>
      ...
      <View style={{ flex: 1, marginLeft: 10 }}>
        ...
        <View style={styles.qtyContainer}>
          <TouchableOpacity
            style={styles.qtyBtn}
            onPress={() => removeFromCart(item.productData.id)}
          >
          ...
          <TouchableOpacity
            style={styles.qtyBtn}
            onPress={() => addToCart(item.productData)}
          >
            <Text style={styles.qtyText}>+</Text>
          </TouchableOpacity>
        </View>
        <TouchableOpacity style={styles.qtyBtn} onPress={() => navigation.navigate("ProductDetails", { productId: item.productData.id })}>
          <Text style={styles.qtyBtn}>View Details</Text>
          </TouchableOpacity>
          </View>
      </View>
    </View>
